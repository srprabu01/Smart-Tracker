        ...
        },
        {
          ...
          parameters: {
            ...
            properties: {
              ...
              category: { type: Type.STRING, description: "Optional category for the task, e.g. for fitness (Cardio, Strength) or buy list (Grocery, Travel, etc)" },
              ...
              isBuyList: { type: Type.BOOLEAN, description: "True if this is a buy list item (grocery, shopping, travel, hobby, beauty care, etc)" },
                ...
                try {
                    if (fc.name === 'getTasks') {
                        ...
                        onAddTask({
                            ...
                            isBuyList: (fc.args.isBuyList as boolean) || false,
